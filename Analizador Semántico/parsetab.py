...
_lr_productions = [
  ...
  ('program -> assignment','program',1,'p_program','syntax.py',64),
  ('program -> assignment program','program',2,'p_program','syntax.py',65),
  ('assignment -> IDENTIFIER EQUALS expression SEMICOLON','assignment',4,'p_assignment','syntax.py',73),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','syntax.py',78),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','syntax.py',79),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','syntax.py',80),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','syntax.py',81),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','syntax.py',85),
  ('expression -> NUMBER','expression',1,'p_expression_number','syntax.py',89),
  ('expression -> IDENTIFIER','expression',1,'p_expression_identifier','syntax.py',93),
]
